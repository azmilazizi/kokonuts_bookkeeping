...
class _PurchaseOrdersTabState extends State<PurchaseOrdersTab> {
  ...
  int _rawCompareOrders(PurchaseOrder a, PurchaseOrder b) {
    switch (_sortColumn) {
      ...
      case PurchaseOrderSortColumn.deliveryStatus:
        final left = a.deliveryStatus;
        final right = b.deliveryStatus;
        if (left == right) {
          return 0;
        }
        return left < right ? -1 : 1;
      ...
      child: Row(
        children: [
          ...
          SortableHeaderCell(
            ...
            theme: theme,
            textAlign: TextAlign.center,
            isActive: sortColumn == PurchaseOrderSortColumn.deliveryStatus,
            ascending: sortAscending,
            onTap: () => onSort(PurchaseOrderSortColumn.deliveryStatus),
          ),
          SortableHeaderCell(
            label: 'Total',
            flex: _columnFlex[6],
